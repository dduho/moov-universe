  ...
  <div class="space-y-4">
    ...
    <div class="flex flex-col gap-2 sm:hidden">
      ...
      <button
        type="button"
        @click="triggerCamera"
        class="flex-1 flex items-center justify-center gap-2 px-3 py-3 bg-moov-orange text-white font-bold rounded-xl hover:bg-moov-orange-dark transition-all duration-200 active:scale-95 touch-manipulation min-h-[48px]"
      >
      ...
      <!-- Choose File Button (Mobile) -->
      <button
        type="button"
        @click="triggerFileInput"
        class="flex-1 flex items-center justify-center gap-2 px-3 py-3 bg-white border-2 border-gray-300 text-gray-700 font-bold rounded-xl hover:border-moov-orange hover:bg-gray-50 transition-all duration-200 active:scale-95 touch-manipulation min-h-[48px]"
      >
        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z"></path>
        </svg>
        <span class="text-sm">📁 Choisir fichier</span>
      </button>
    </div>
    ...
    <div
      ...
      class="hidden sm:block relative border-2 border-dashed rounded-2xl p-8 transition-all duration-200 cursor-pointer"
      :class="isDragging 
