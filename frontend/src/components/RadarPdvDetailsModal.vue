  ...
  <Teleport to="body">
    ...
    >
      <section ref="modalPanel" class="flex max-h-[94vh] w-full max-w-4xl flex-col overflow-hidden rounded-t-3xl bg-white shadow-2xl sm:rounded-3xl">
        ...
        <footer class="flex shrink-0 justify-end border-t border-gray-200 bg-gray-50 px-5 py-3 sm:px-6">
          <button type="button" class="min-h-11 rounded-xl bg-gradient-to-r from-moov-orange to-moov-orange-dark px-6 py-2.5 font-bold text-white shadow transition-shadow hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-moov-orange focus:ring-offset-2" @click="emit('close')">Fermer</button>
        </footer>
      </section>
    </div>
  </Teleport>
