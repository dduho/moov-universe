<template>
  <div class="min-h-screen bg-gradient-mesh">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
      <!-- Header -->
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-4 mb-5 sm:mb-8">
        <h1 class="text-[22px] sm:text-3xl font-bold text-gray-900 leading-tight">Gestion des utilisateurs</h1>
        <div class="flex w-full sm:w-auto items-center gap-2 sm:gap-3">
          ...
          <button
            ...
            class="flex-1 sm:flex-none px-4 sm:px-6 py-2.5 sm:py-3 rounded-xl bg-moov-orange text-white font-bold hover:shadow-xl hover:scale-[1.02] transition-all duration-200 flex items-center justify-center gap-2 text-sm sm:text-base"
          >
      ...
      <!-- Filters -->
      <div class="bg-white/90 backdrop-blur-md border border-white/50 shadow-2xl p-4 sm:p-6 mb-6 sm:mb-8 rounded-2xl">
      ...
      <!-- Stats Cards -->
      <div class="flex gap-3 overflow-x-auto pb-3 -mx-4 px-4 sm:mx-0 sm:px-0 sm:grid sm:grid-cols-2 md:grid-cols-4 mb-6 sm:mb-8">
        <div class="bg-white/90 backdrop-blur-md border border-white/50 shadow-2xl p-4 sm:p-6 flex-shrink-0 min-w-[168px] sm:w-auto rounded-2xl">
        ...
        <div class="bg-white/90 backdrop-blur-md border border-white/50 shadow-2xl p-4 sm:p-6 rounded-2xl">
          <div class="flex items-center justify-between">
            <div>
              <p class="text-xs sm:text-sm font-semibold text-gray-600">Admins</p>
              <p class="text-2xl sm:text-3xl font-bold text-purple-600">{{ stats.admins }}</p>
            </div>
        ...
        <div class="bg-white/90 backdrop-blur-md border border-white/50 shadow-2xl p-4 sm:p-6 rounded-2xl">
          <div class="flex items-center justify-between">
            <div>
              <p class="text-xs sm:text-sm font-semibold text-gray-600">Dealers</p>
              <p class="text-2xl sm:text-3xl font-bold text-moov-orange">{{ stats.dealers }}</p>
            </div>
      ...
      <!-- Loading State -->
      <div v-if="loading" class="bg-white/90 backdrop-blur-md border border-white/50 shadow-2xl p-10 sm:p-12 text-center rounded-2xl">
      ...
      <!-- Users List -->
      <div v-else class="bg-white/90 backdrop-blur-md border border-white/50 shadow-2xl rounded-2xl overflow-hidden">
        <!-- Mobile Cards -->
        <div class="md:hidden divide-y divide-gray-100">
          ...
          >
            <div class="flex items-start justify-between gap-3">
              <div class="flex items-center gap-3">
                <div class="w-12 h-12 rounded-full bg-gradient-to-r from-moov-orange to-moov-orange-dark flex items-center justify-center text-white font-bold text-lg">
                ...
                <div>
                  ...
                  <p class="text-xs text-gray-500">{{ user.organization?.name || 'N/A' }}</p>
                </div>
              </div>
              <span
            ...
            <div class="grid grid-cols-1 gap-2 text-sm text-gray-700">
              ...
              <div class="flex items-center gap-2">
                <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5h2l3 7-1.5 2.5M3 5h11l4 8H8m-5 0h5m0 0l1.5 3 3.5-6m0 0L13 5m0 0h8"></path>
                </svg>
            ...
            <div class="flex items-center justify-between pt-1">
              <button
                ...
                class="inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-gray-50 text-xs font-semibold"
              >
                <span
                  class="w-3 h-3 rounded-full"
                  :class="user.is_active ? 'bg-green-500' : 'bg-gray-400'"
                ></span>
                <span :class="user.is_active ? 'text-green-700' : 'text-gray-600'">
              ...
              <div class="flex items-center gap-2">
                ...
                <button
                  ...
                  class="p-2.5 rounded-lg bg-yellow-50 text-yellow-600 hover:bg-yellow-100 transition-all"
                ...
                <button
                  ...
                  class="p-2.5 rounded-lg bg-red-50 text-red-600 hover:bg-red-100 transition-all"
                  title="Supprimer"
                >
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <!-- Empty State -->
          <div v-if="filteredUsers.length === 0" class="py-10 text-center">
            <svg class="w-14 h-14 mx-auto mb-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path>
            </svg>
